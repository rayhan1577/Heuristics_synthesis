...
class BottomUpSearch():
    def __init__(self):
        ...
        self.program_evaluated = 4 #initial programs of cost 2 who aren't evaluated
        self.size = 0
        self.final_flag = 0
        self.cost = {}
        self.dict = {}
    ...
    def synthesize(self, bound, operation, var, inputs_output):
        ...
        init_flag = 0
        # build cost map
        self.cost[Replace] = int(-math.log(.188, 2))
        self.cost[Concat] = int(-math.log(.059, 2))
        self.cost['args'] = int(-math.log(.188, 2))
        for i in var:
            self.cost[i] = int(-math.log(.188, 2))
